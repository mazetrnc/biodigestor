...
float calibration = 2.38; //change this value to calibrate
int sensorValue = 0;
...
float ph = (-5.70 * pHVol + calibration)*-1;
  ...
  Serial.print(F("Internal Temp: ")); Serial.print(internalTemp); Serial.println(F(" C"));
  Serial.print(F("Soil Moisture: ")); Serial.print(soilMoisture); Serial.println(F("%"));
  Serial.print(F("LPG: ")); Serial.print(lpgPPM); Serial.println(F(" ppm"));
  Serial.print(F("MQ-2 Analog: ")); Serial.println(mq2AnalogValue);
